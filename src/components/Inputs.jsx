    ...
    <div className='flex flex-row justify-center my-6'>
        <div className='flex flex-row w-3/4 items-center justify-center space-x-3'>
            <input 
                ...
                className='bg-white text-gray-500 text-xl p-2 w-full shadow-xl capitalize focus:outline-none placeholder:lowercase'
            />
        ...
        <div className='flex flex-row w-1/4 items-center justify-center space-x-3'>
            <button className='cursor-pointer text-xl font-medium transition ease-out hover:scale-125'
